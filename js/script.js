...
document.addEventListener(RENDER_EVENT, () => {
    ...
    const Read = document.getElementById("doneRead");
    Read.innerHTML = "";
...
document.addEventListener(SAVED_EVENT, () => {
    ...
    elementCustomAlert.innerText = "Successful Input!!";
...
document.addEventListener(MOVED_EVENT, () => {
    const elementCustomAlert = document.createElement("div");
    elementCustomAlert.classList.add("alert");
    elementCustomAlert.innerText = "Successful transfer";
...
const addBook = () => {
    ...
    const bookYear = document.getElementById("publish");
